  ...
  <div className={styles.wrapper}>
    <div className={styles.guide}>
      ...
      <div className={styles.block}>
        ...
        <h1 className={styles.heading1Article}>H1 - for all sub pages</h1>
      ...
      <div className={styles.block}>
        <p className={cx('hasDropCap', styles.paragraph)}>
          This is paragraph with dropcap. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
        ...
        <p className={styles.paragraph}>
          This is paragraph without dropcap. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
